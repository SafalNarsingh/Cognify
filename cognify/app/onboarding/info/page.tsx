        ...
        <div className="bg-white p-10 rounded-3xl border border-gray-100 shadow-sm space-y-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="space-y-2">
              ...
              <select className="w-full px-4 py-3 rounded-xl bg-[#F9F9F7] border-none focus:ring-1 focus:ring-[#5F7A7B] outline-none text-gray-500 placeholder-gray-400">
          ...
          <Link href="/onboarding/screening">
            <div className="mt-8">
                <button className="w-full bg-[#5F7A7B] text-white py-4 rounded-xl hover:bg-[#4D6364] transition-all font-medium cursor-pointer">
